...
public class DriveTrain extends Subsystem {
    ...
    public DriveTrain() {
        ...
        leftFront = new Victor(DataBase.leftFrontMotorPWM);
        addChild("LeftFront", leftFront);
        leftFront.setInverted(false);
        
        leftRear = new Victor(DataBase.leftRearMotorPWM);
        addChild("LeftRear", leftRear);
        leftRear.setInverted(false);

        rightFront = new Victor(DataBase.rightFrontMotorPWM);
        addChild("RightFront", rightFront);
        rightFront.setInverted(false);

        rightRear = new Victor(DataBase.rightRearMotorPWM);
